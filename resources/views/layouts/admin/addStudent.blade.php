        ...
        <div class="container">
            ...
            <div class="row">
                <div class="inputs-field">
                    ...
                    <input type="number" placeholder="رقم الهاتف" name="phone" value="{{ old('phone') }}">
                    @if ($errors->has('phone'))
                ...
                <div class="inputs-field">
                    ...
                    <input type="text" placeholder="تاريخ الميلاد" name="place_barth" value="{{ old('place_barth') }}">
                    @if ($errors->has('place_barth'))
                        <span class="text-danger">{{ $errors->first('place_barth') }}</span>
                    @endif
                    <label>تاريخ الميلاد </label>
                    <input type="datetime-local" placeholder="مكان الميلاد" name="barth_date" value="{{ old('barth_date') }}">
                ...
                <div class="inputs-field">
                    ...
                    <input type="text" placeholder="هوية الطالب " name="card_id" value="{{ old('card_id') }}">
                    @if ($errors->has('card_id'))
                        <span class="text-danger">{{ $errors->first('card_id') }}</span>
                    @endif
                    <label>هوية الاب </label>
                    <input type="text" placeholder="هوية الاب" name="father_card_id" value="{{ old('father_card_id') }}">
                ...
                <div class="inputs-field">
                    ...
                    <select name="clas_id" id="halaqah">
                        @foreach($classess as $clas)
                            <option  value="{{ old('name', $clas->id) }}"> {{ $clas->name }}</option>
                        @endforeach
                    </select>
